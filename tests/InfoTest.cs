...
public class InfoTest
{
	...
	public void TestMinimal()
	{
		...
		Assert.Equal(@"<info v=""" + Info.LevelXMLVersion + @""" x=""NaN"" y=""NaN"" c=""1"" f=""f"" h=""f"" bg=""NaN"" bgc=""16777215"" e=""1"" />",
	...
	public void TestNaN()
	{
		...
		Assert.Equal(@"<info v=""" + Info.LevelXMLVersion + @""" x=""NaN"" y=""NaN"" c=""1"" f=""f"" h=""f"" bg=""NaN"" bgc=""NaN"" e=""1"" />",
			info.ToXML(), ignoreWhiteSpaceDifferences:true, ignoreLineEndingDifferences: true);
	}
	...
	public void TestLowValues()
	{
		...
		Assert.Equal(@"<info v=""" + Info.LevelXMLVersion + @""" x=""0"" y=""0"" c=""1"" f=""f"" h=""f"" bg=""-99999"" bgc=""0"" e=""1"" />",
			info.ToXML(), ignoreWhiteSpaceDifferences:true, ignoreLineEndingDifferences: true);
	}
	...
	{
		Info info = new(@"<info v=""99999"" x=""0"" y=""0"" c=""99999"" f=""f"" h=""f"" bg=""99999"" bgc=""0"" e=""1""/>");
		Assert.Equal(@"<info v=""" + Info.LevelXMLVersion + @""" x=""0"" y=""0"" c=""11"" f=""f"" h=""f"" bg=""99999"" bgc=""0"" e=""1"" />",
			info.ToXML(), ignoreWhiteSpaceDifferences:true, ignoreLineEndingDifferences: true);
	}
